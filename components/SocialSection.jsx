      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 lg:px-20 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] uppercase font-body text-gold tracking-widest">
                  For Man
                </span>
              </div>
            </div>
            
            <p className="text-xs text-white/60 font-body font-light leading-relaxed max-w-sm">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <h4 className="text-xs font-semibold text-gold uppercase tracking-[0.2em] font-body mb-1">
              Ritual Locations
            </h4>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <span className="text-xs text-white/50 font-body block uppercase tracking-wider">
                  Address
                </span>
                <a
                  ...
                  className="text-sm text-white/85 hover:text-gold transition-colors duration-300 font-body font-light mt-1 block"
                >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-white/85 font-body font-light mt-1">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 border-t border-white/5 pt-4">
              ...
              <a
                ...
                className="text-base text-gold hover:text-gold-light transition-colors font-body font-semibold"
              >
                +84 (0) 99 999 9999
              </a>
            </div>
