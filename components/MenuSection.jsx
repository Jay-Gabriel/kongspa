      ...
      <div className="relative z-10 px-6 md:px-16 lg:px-20 pt-28 pb-16 flex flex-col min-h-screen justify-between max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch flex-1">
          ...
          >
                  ...
                  {cat.items.map((item, itemIdx) => (
                    ...
                    >
                      <div className="flex-1 pr-4">
                        <h4 className="text-sm font-semibold text-white/95 group-hover:text-gold transition-colors duration-300">
                          {item.name}
                        </h4>
                        <p className="text-[11px] text-white/60 font-body font-light mt-0.5 italic">
                          {item.vietnamese}
                        </p>
                      </div>
            ...
            >
              <span className="text-xs font-bold text-gold uppercase tracking-[0.25em] font-body">
                ✦ Special Offer / Ưu Đãi Đặc Biệt ✦
              </span>
              <p className="text-base font-semibold text-white/95 font-body">
                50.000 VNĐ OFF when using 2 or more services
              </p>
              <p className="text-xs text-gold-light font-body font-light">
